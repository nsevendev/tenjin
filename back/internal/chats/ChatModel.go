...
type ChatChannel struct {
	...
	Status         constantes.StatusState `bson:"status" validate:"required"` // Statut du salon : active, archived ou deleted - Obligatoire
}
...
// LastMessagePreview stocker le dernier message pour éventuellement l'afficher dans la preview du canal
